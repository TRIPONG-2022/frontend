...
import * as Styled from './ProfileDatePicker.styled';
...
const DatePickerHeader = ({
  ...
  return (
    <Styled.DatePickerHeaderContainer>
      ...
      <div>
        <Styled.DatePickerHeaderUtilButton onClick={decreaseMonth}>
          <SVGIcon icon="ChevronLeftIcon" size="12" />
        </Styled.DatePickerHeaderUtilButton>
        <Styled.DatePickerHeaderUtilButton onClick={increaseMonth}>
